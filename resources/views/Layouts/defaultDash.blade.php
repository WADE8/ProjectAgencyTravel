...
<body data-col="2-columns" class="2-columns">
    <!-- ////////////////////////////////////////////////////////////////////////////-->
    <div class="wrapper">
        <div data-active-color="white" data-background-color="aqua-marine"
            data-image="../app-assets/img/sidebar-bg/02.jpg" class="app-sidebar">
            <div class="sidebar-header">
                <div class="logo clearfix">
                    <a href="index.html" class="logo-text float-left">
                        <span class="text align-middle">Dashboard</span>
                    ...
                    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                        <li class=" nav-item">
                            <a href="#"><i class="icon-home"></i><span data-i18n=""
                                    class="menu-title">Dash</span><span
                                    class="tag badge badge-pill badge-danger mt-1"></span></a>

                        </li>
                        <li class="has-sub nav-item">
                            <a href="#"><i class="icon-screen-desktop"></i><span data-i18n=""
                                    class="menu-title">Voyages</span></a>
                            <ul class="menu-content">
                                <li><a  href="{{ route('voyage.create') }}" class="menu-item">Nouveau voyage </a></li>
                                <li>
                                    <a  href="{{ route('voyage.index') }}" class="menu-item">Liste des voyages </a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub nav-item">
                            <a href="#"><i class="icon-magnet"></i><span data-i18n="" class="menu-title">Clients
                                    </span></a>
                            <ul class="menu-content">
                                <li>
                                    <a  href="{{ route('client.create') }}" class="menu-item">Nouveau client</a>
                                </li>
                                <li>
                                    <a href="{{ route('client.index') }} " class="menu-item">Liste des clients</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub nav-item">
                            <a href="#"><i class="icon-magnet"></i><span data-i18n="" class="menu-title">Bus
                                    </span></a>
                            <ul class="menu-content">
                                <li>
                                    <a  href="{{ route('bus.create') }}" class="menu-item">Nouveau Bus</a>
                                </li>
                                <li>
                                    <a href="{{ route('bus.index') }} " class="menu-item">Liste des bus</a>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="navbar-header">
                    ...
                    <div class="dropdown ml-2 display-inline-block">
                        ...
                        <div class="apps dropdown-menu">
                            <div class="arrow_box">
                                <a href="chat.html" class="dropdown-item py-1"><span>Chat</span></a><a
                                    href="taskboard.html" class="dropdown-item py-1"><span>TaskBoard</span></a><a
                                    href="calendar.html" class="dropdown-item py-1"><span>Calendar</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <div class="arrow_box_right">
                                        <a href="javascript:;" class="dropdown-item py-1"><img
                                                src="{{ asset('app-assets/img/flags/us.png') }}" alt="English Flag"
                                                class="langimg" /><span> English</span></a><a href="javascript:;"
                                            class="dropdown-item py-1"><img src="{{ asset('app-assets/img/flags/es.png"
                                            alt="Spanish Flag') }}" class="langimg" /><span> Spanish</span></a><a
                                            href="javascript:;" class="dropdown-item py-1"><img
                                                src="{{ asset('app-assets/img/flags/br.png') }}" alt="Portuguese Flag"
                                                class="langimg" /><span> Portuguese</span></a><a href="javascript:;"
                                            class="dropdown-item"><img src="{{ asset('app-assets/img/flags/de.png') }}"
                                                alt="French Flag" class="langimg" /><span> French</span></a>
                                    </div>
                                </div>
                            </li>
                            <li class="dropdown nav-item mt-1">
                                ...
                                <div class="notification-dropdown dropdown-menu dropdown-menu-right">
                                    <div class="arrow_box_right">
                                        <div class="noti-list">
                                            <a class="dropdown-item noti-container py-2"><i
                                                    ...
                                                    class="noti-wrapper"><span
                                                        ...
                                                        Order Received</span><span class="noti-text">Lorem ipsum dolor
                                                        sit ametitaque in, et!</span></span></a><a
                                                class="dropdown-item noti-container py-2"><i
                                                    ...
                                                    class="noti-wrapper"><span
                                                        ...
                                                        User Registered</span><span class="noti-text">Lorem ipsum dolor
                                                        sit ametitaque in
                                                ...
                                                class="dropdown-item noti-container py-2"><i
                                                    ...
                                                    class="noti-wrapper"><span
                                                        ...
                                                        Item In Your Cart</span><span class="noti-text">Lorem ipsum
                                                        dolor sit ametnatus aut.</span></span></a><a
                                                class="dropdown-item noti-container py-2"><i
                                                    class="ft-heart info float-left d-block font-medium-4 mt-2 mr-2"></i><span
                                                    class="noti-wrapper"><span
                                                        class="noti-title line-height-1 d-block text-bold-400 info">New
                                                        Sale</span><span class="noti-text">Lorem ipsum dolor sit
                                                        ametnatus aut.</span></span></a><a
                                                class="dropdown-item noti-container py-2"><i
                                                    class="ft-box warning float-left d-block font-medium-4 mt-2 mr-2"></i><span
                                                    class="noti-wrapper"><span
                                                        class="noti-title line-height-1 d-block text-bold-400 warning">Order
                                                        Delivered</span><span class="noti-text">Lorem ipsum dolor sit
                                                        ametnatus aut.</span></span></a>
                                        </div>
                                        <a
                                ...
                                <div aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right">
                                    <div class="arrow_box_right">
                                        <a href="user-profile-page.html" class="dropdown-item py-1"><i
                                                class="ft-edit mr-2"></i><span>My Profile</span></a><a
                                            href="chat.html" class="dropdown-item py-1"><i
    ...
    <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block">
        ...
        <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a"
            ...
            <div class="cz-bg-image row">
                <div class="col mb-3">
                    <img src="{{ asset('app-assets/img/sidebar-bg/01.jpg') }}" width="50" height="100" alt="Bg image1"
                        class="rounded box-shadow-2" />
                </div>
                <div class="col mb-3">
                    <img src="{{ asset('app-assets/img/sidebar-bg/02.jpg') }}" width="50" height="100" alt="Bg image2"
                        class="rounded box-shadow-2" />
                </div>
                <div class="col mb-3">
                    <img src="{{ asset('app-assets/img/sidebar-bg/03.jpg') }}" width="50" height="100" alt="Bg image3"
                        class="rounded box-shadow-2" />
                </div>
                <div class="col mb-3">
                    <img src="{{ asset('app-assets/img/sidebar-bg/04.jpg') }}" width="50" height="100" alt="Bg image4"
                        class="rounded box-shadow-2" />
                </div>
                <div class="col mb-3">
                    <img src="{{ asset('app-assets/img/sidebar-bg/05.jpg') }}" width="50" height="100" alt="Bg image5"
                        class="rounded box-shadow-2" />
                </div>
                <div class="col mb-3">
                    <img src="{{ asset('app-assets/img/sidebar-bg/06.jpg') }}" width="50" height="100" alt="Bg image6"
                        class="rounded box-shadow-2" />
                </div>
                <div class="col mb-3">
                    <img src="{{ asset('app-assets/img/sidebar-bg/07.jpg') }}" width="50" height="100" alt="Bg image7"
                        class="rounded box-shadow-2" />
                </div>
                <div class="col mb-3">
                    <img src="{{ asset('app-assets/img/sidebar-bg/08.jpg') }}" width="50" height="100" alt="Bg image8"
                        class="rounded box-shadow-2" />
                </div>
            </div>
            <hr />
                ...
                <div class="row p-1">
                    <div class="col mb-3">
                        <span style="width: 50px; height: 100px" data-bg-color="aqua-marine"
                            class="gradient-aqua-marine d-block rounded box-shadow-2"></span>
                    </div>
                    <div class="col mb-3">
                        <span style="width: 50px; height: 100px" data-bg-color="sublime-vivid"
                            class="gradient-sublime-vivid d-block rounded box-shadow-2"></span>
                    </div>
                    <div class="col mb-3">
                        <span style="width: 50px; height: 100px" data-bg-color="crystal-clear"
                            class="gradient-crystal-clear d-block rounded box-shadow-2"></span>
                    </div>
                    <div class="col mb-3">
                        <span style="width: 50px; height: 100px" data-bg-color="timber"
                            class="gradient-timber d-block rounded box-shadow-2"></span>
                    </div>
                </div>
                <div class="row p-1">
                    <div class="col mb-3">
                        <span style="width: 50px; height: 100px" data-bg-color="black"
                            class="bg-black d-block rounded box-shadow-2"></span>
                    </div>
                    <div class="col mb-3">
                        <span style="width: 50px; height: 100px" data-bg-color="white"
                            class="bg-white d-block rounded box-shadow-2"></span>
                    </div>
                    <div class="col mb-3">
                        <span style="width: 50px; height: 100px" data-bg-color="primary"
                            class="bg-primary d-block rounded box-shadow-2"></span>
                    </div>
                    <div class="col mb-3">
                        <span style="width: 50px; height: 100px" data-bg-color="danger"
                            class="bg-danger d-block rounded box-shadow-2"></span>
                    </div>
                </div>
            </div>
            <hr />
