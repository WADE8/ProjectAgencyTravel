                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="px-3">
                                            <form class="form form-horizontal" action="{{ route('client.update',$client->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-body">
                                                    <h4 class="form-section">
                                                        <i class="icon-user"></i>  Modifier les details du Client
                                                    </h4>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="number" id="projectinput3" class="form-control"
                                                                name="Numero" value="{{ $client->Numero }}">
                                                        </div>
                                                    </div>
